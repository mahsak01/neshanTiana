...
class LastVisitsLocationMapFragment:Fragment() {
    ...
    override fun onCreateView(
        ...
        binding = FragmentLastVisitsLocationMapBinding.inflate(layoutInflater, container, false)
        return binding.root
    }
    ...
    private fun setListener() {
        this.binding.FragmentLastVisitsLocationMapMyLocationBtn.setOnClickListener {
