...
class SearchLocationCustomerMapFragment : Fragment(), SearchCustomerItemAdapter.EventListener {
    ...
    private fun setListener() {
        this.binding.FragmentSearchLocationCustomerMyLocationBtn.setOnClickListener {
        ...
        this.binding.FragmentSearchLocationCustomerCustomerNameTIET.setOnClickListener {
    ...
    override fun click(customer: Customer) {
        ...
        if (customer != null) {
            this.binding.FragmentSearchLocationCustomerCustomerNameTI.editText!!.text =
